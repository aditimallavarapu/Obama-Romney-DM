...
f =open("MultinomialNB_obama.txt","wb")
predict_list = write_to_file_tfidf(f,classifier,tweet_list,labels)
...
f =open("BernouliNB_obama.txt","wb")
predict_list = write_to_file_tfidf(f,classifier,tweet_list,labels)
...
f =open("Decisiontree_obama.txt","wb")
predict_list = write_to_file_tfidf(f,classifier,tweet_list,labels)
...
f =open("Random_Forests_obama.txt","wb")
predict_list = write_to_file_tfidf(f,classifier,tweet_list,labels)
...
f =open("Polynomial_SVM_obama.txt","wb")
predict_list = write_to_file_tfidf(f,classifier,tweet_list,labels)
